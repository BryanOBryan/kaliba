 ...
 *
 * `Arraybag` provides an improved interface, more consistent and
 * predictable set of features over `Set`. While it lacks the spotty
 * support for pseudo Xpath, its more fully featured dot notation provides
 * similar features in a more consistent implementation.
 * 
 * This class is partly based on the CakePHP(tm) Framework and Laravel Framework
 * 
 */
class Arraybag
{
     ...
     * @return array
     */
    public static function append(&$array,$key, $value=null)
    {
